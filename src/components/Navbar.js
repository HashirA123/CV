...
function Navbar() {
    ...
    return (
        <>
            <nav>
                <div className="nav">
                <Link to="Home" offset={-150} ><h2>Welcome</h2></Link>
                <ul>
                    ...
                    <li><Link to="Projects" activeClass='active' offset={-100} spy={true}  onClick={navclose}><i className='fas fa-archive' ></i>Projects</Link></li>
